		...
		<div class="pay-page">
			...
			<div>
				...
				<div class="box-three3">
					...
					<form action="productPay.bo">
						<input style="display: none;" id="price" value="${b.price}" readonly="readonly">
						<input style="display: none;" id="memberNo" value="${loginUser.memberNo}" readonly="readonly">
						<input style="display: none;" id="boardNo" value="${b.boardNo}" readonly="readonly">
						<!-- 
